...
public class Base64Utils {
    ...
    public static byte[] decode(byte[] input, int offset, int len, int flags) throws IllegalArgumentException {
        Base64Utils.Decoder decoder = new Base64Utils.Decoder(flags, new byte[len * 3 / 4]);
    ...
    public static byte[] encode(byte[] input, int offset, int len, int flags) {
        Base64Utils.Encoder encoder = new Base64Utils.Encoder(flags, (byte[])null);
    ...
    static class Encoder extends Base64Utils.Coder {
    ...
    static class Decoder extends Base64Utils.Coder {
